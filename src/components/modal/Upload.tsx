...
import ModalConfirm from './Confirm.tsx';
...
export const UploadPersyaratan = ({ isOpen, onClose }: UploadPersyaratanProps): JSX.Element | null => {
...
export const UploadPendaftaran: React.FC<UploadPendaftaranProps> = ({ isOpen, onClose }) => {
  const [showConfirmation, setShowConfirmation] = useState<boolean>(false);
...
export const UploadPascaSeminar: React.FC<UploadPascaSeminarProps> = ({ isOpen, onClose }) => {
  const [showConfirmation, setShowConfirmation] = useState<boolean>(false);
